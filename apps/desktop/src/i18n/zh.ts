const zh: Record<string, string> = {
  ...
  "settings.audioPreprocessing": "音频预处理",
  "settings.audioDenoise": "降噪",
  "settings.audioPeakNormalize": "自动音量归一化",
  "settings.audioResampleQuality": "重采样质量",
  "settings.audioResampleQualityFast": "快速",
  "settings.audioResampleQualityHigh": "高质量",
