const en: Record<string, string> = {
  ...
  "settings.audioPreprocessing": "Audio preprocessing",
  "settings.audioDenoise": "Noise reduction",
  "settings.audioPeakNormalize": "Auto volume normalization",
  "settings.audioResampleQuality": "Resample quality",
  "settings.audioResampleQualityFast": "Fast",
  "settings.audioResampleQualityHigh": "High quality",
